...
namespace WebExpress.Tutorial.WebUI.WebControl
{
    ...
    public class ControlModalExample : ControlModal
    {
            ...
            : base(id)
        {
            ...
            Add(new ControlText()
            {
                Text = _ => "One point twenty-one gigawatts. One point twenty-one gigawatts. Great Scott. You're gonna break his arm. Biff, leave him alone. Let him go. Let him go. What was it, George, bird watching? Oh, great scott. You get the cable, I'll throw the rope down to you. It's safe now. Everything's lead lined. Don't you lose those tapes now, we'll need a record. Wup, wup, I almost forgot my luggage. Who knows if they've got cotton underwear in the future. I'm allergic to all synthetics."
            },
            new ControlText()
            {
