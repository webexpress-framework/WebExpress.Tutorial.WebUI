...
namespace WebUI.WWW.Controls.Form
{
    ...
    public sealed class Selection : PageControl
    {
        ...
        public Selection(IPageContext pageContext, ISitemapManager sitemapManager)
        {
            ...
            Stage.Control = new ControlForm(new ControlFormItemInputSelection(null, [.. _options])
            {
            ...
            (
                ...
                "MultiSelect = true",
                new ControlForm(new ControlFormItemInputSelection(null, [.. _options])
                {
                    MultiSelect = true
                })
            );
            ...
            (
                ...
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label 1" })
                {
                })
            );
            ...
            (
                ...
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", Content = new ControlText() { Text = "Full **description** of the selection option", Format = TypeFormatText.Markdown } })
                {
                })
            );
            ...
            (
                ...
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Icon = new IconHome() })
                {
                })
            );
            ...
            (
                ...
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", Selected = true })
                {
                })
            );
            ...
            (
                ...
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", LabelColor = TypeColorSelection.Default, Selected = true })
                {
                }),
                new ControlText() { Text = "Primary", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", LabelColor = TypeColorSelection.Primary, Selected = true })
                {
                }),
                new ControlText() { Text = "Secondary", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", LabelColor = TypeColorSelection.Secondary, Selected = true })
                {
                }),
                new ControlText() { Text = "Info", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", LabelColor = TypeColorSelection.Info, Selected = true })
                {
                }),
                new ControlText() { Text = "Success", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", LabelColor = TypeColorSelection.Success, Selected = true })
                {
                }),
                new ControlText() { Text = "Warning", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", LabelColor = TypeColorSelection.Warning, Selected = true })
                {
                }),
                new ControlText() { Text = "Danger", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", LabelColor = TypeColorSelection.Danger, Selected = true })
                {
                }),
                new ControlText() { Text = "Light", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", LabelColor = TypeColorSelection.Light, Selected = true })
                {
                }),
                new ControlText() { Text = "Dark", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(new ControlFormItemInputSelection(null, new ControlFormItemInputSelectionItem() { Label = "Label", LabelColor = TypeColorSelection.Dark, Selected = true })
                {
                })
            );
        }
