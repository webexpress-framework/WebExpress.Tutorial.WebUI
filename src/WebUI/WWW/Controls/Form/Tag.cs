    ...
    public sealed class Tag : PageControl
    {
        ...
        public Tag(IPageContext pageContext, IComponentHub componentHub)
        {
            ...
            (
                ...
                new ControlForm(items: new ControlFormItemInputTag() { Color = new PropertyColorTag(TypeColorTag.Default) }.Initialize(x => x.Value = "Default")),
                new ControlText() { Text = "Primary", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(items: new ControlFormItemInputTag() { Color = new PropertyColorTag(TypeColorTag.Primary) }.Initialize(x => x.Value = "Primary")),
                new ControlText() { Text = "Secondary", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(items: new ControlFormItemInputTag() { Color = new PropertyColorTag(TypeColorTag.Secondary) }.Initialize(x => x.Value = "Secondary")),
                new ControlText() { Text = "Info", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(items: new ControlFormItemInputTag() { Color = new PropertyColorTag(TypeColorTag.Info) }.Initialize(x => x.Value = "Info")),
                new ControlText() { Text = "Success", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(items: new ControlFormItemInputTag() { Color = new PropertyColorTag(TypeColorTag.Success) }.Initialize(x => x.Value = "Success")),
                new ControlText() { Text = "Warning", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(items: new ControlFormItemInputTag() { Color = new PropertyColorTag(TypeColorTag.Warning) }.Initialize(x => x.Value = "Warning")),
                new ControlText() { Text = "Danger", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(items: new ControlFormItemInputTag() { Color = new PropertyColorTag(TypeColorTag.Danger) }.Initialize(x => x.Value = "Danger")),
                new ControlText() { Text = "Light", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(items: new ControlFormItemInputTag() { Color = new PropertyColorTag(TypeColorTag.Light) }.Initialize(x => x.Value = "Light")),
                new ControlText() { Text = "Dark", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(items: new ControlFormItemInputTag() { Color = new PropertyColorTag(TypeColorTag.Dark) }.Initialize(x => x.Value = "Dark")),
                new ControlText() { Text = "User defind", TextColor = new PropertyColorText(TypeColorText.Info) },
                new ControlForm(items: new ControlFormItemInputTag() { Color = new PropertyColorTag("gold") }.Initialize(x => x.Value = "User defind"))
            );
