    ...
    public sealed class Tag : PageControl
    {
        ...
        public Tag(IPageContext pageContext, IComponentHub componentHub)
        {
            ...
            (
                ...
                "Label = _ => \"Label 1\"",
                new ControlForm(null, new ControlFormItemInputTag() { Label = _ => "Label 1" })
            );
            ...
            (
                ...
                "Icon = _ => new IconHome()",
                new ControlForm(null, new ControlFormItemInputTag() { Icon = _ => new IconHome() })
            );
            ...
            (
               ...
               new ControlForm(null, new ControlFormItemInputTag() { Help = _ => "This is a help text." })
            );
        }
    }
}
