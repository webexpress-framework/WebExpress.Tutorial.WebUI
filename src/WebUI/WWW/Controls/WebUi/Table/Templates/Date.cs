...
{
    /// <summary>    
    /// Represents the date template of a table control for the tutorial.    
    /// </summary>    
    [Title("Date-Template")]
    [Scope<IScopeGeneral>]
    [Scope<IScopeControl>]
    ...
    public sealed class Date : PageControl
    {
        ...
        public Date()
        {
            ...
            Stage.Description = @"The `Date` template defines the visual representation of date values within a column. It supports both a ReadOnly mode for displaying dates and an Edit mode for directly modifying them.";
